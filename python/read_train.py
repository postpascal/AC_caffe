...
full_path=[]
i=0
f=open("Ac_train_name.txt","w")
makelmdb('/home/keke/AC_caffe/python/UCF_10/ucf_10_train')
f.close()
#shuffle videos' path
lines = open('Ac_train_name.txt').readlines()
random.shuffle(lines)
open('Ac_train_name.txt', 'w').writelines(lines)
